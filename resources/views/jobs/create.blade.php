        ...
        <form action="/jobs" method="post" enctype="multipart/form-data"
            ...
            <div>
                ...
                <div class="mt-2 flex items-center space-x-4">
                    <label>
                        <input type="radio" name="schedule" value="Full-time" class="form-radio text-blue-500"
                            required>
                        <span class="ml-2">Full-time</span>
                    </label>
                    <label>
                        <input type="radio" name="schedule" value="Part-time" class="form-radio text-blue-500"
                            required>
            ...
            <div>
                <button type="submit"
                    class="bg-tertiary/75 text-white px-6 py-2 rounded-md font-semibold transition-colors duration-300 hover:bg-tertiary/100">Post
                    Job</button>
            </div>
        </form>
    </div>
